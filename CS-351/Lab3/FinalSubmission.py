...
class CatDatabase: # class definition
    def __init__(self):
        self.catList = []

    def add_Cat(self, catinfo):
        self.catList.append(catinfo)
...
class MyFirstGUI:  # class definition
    ...
    def __init__(self, root):
        ...
        self.printDatabase = Button(self.master, text="Print Database", command=self.printDatabase)
    ...
    def submitname(self):
        ...
        if self.catnameentry.get() == "" or self.idEntry.get() == "":
            ...
            # catTuple = tuple((self.catnameentry.get(), self.idEntry.get()))
            # self.catDatabase.add_Cat(self, catTuple)
            self.catDatabase.add_Cat((self.catnameentry.get(), self.idEntry.get()))
